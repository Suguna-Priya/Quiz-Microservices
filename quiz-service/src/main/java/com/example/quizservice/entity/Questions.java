...
public class Questions {
	...
	public String getDiffecultylevel() {
		return diffecultylevel;
	}
	public void setDiffecultylevel(String diffecultylevel) {
	...
	public String toString() {
		return "Questions [id=" + id + ", category=" + category + ", diffecultylevel=" + diffecultylevel + ", option1="
